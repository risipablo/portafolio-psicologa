...
export const Servicios_Data = {
    ...
    "biosalud-integrativa":{
        ...
        text3:' La propuesta consta de dos encuentros: el primero con la  Médica (la Dra. Gisela Stefani) y el segundo con una Psicóloga (Lic. Sabrina Ramos), ambas formadas en salud integrativa, con el objetivo de abordar a la persona desde una perspectiva biopsicosocial y de estilo de vida.',
